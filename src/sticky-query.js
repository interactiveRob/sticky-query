(function (root, factory) {
	...
	stickyQuery.destroy = function () {
		...
		let affectedLinks = nodelistToArray(document.querySelectorAll('[data-sticky-query="true"]'));
	...
	StickyQuery.prototype.getAllowedKeys = function(){
		...
		return this.settings.allowedKeys ? csv_to_array(settings.allowedKeys) : getQueryParameterKeys(this.url);
	}
	
	StickyQuery.prototype.buildPersistedQuery = function(){
		
		return Object.keys(this.persistedParams).map(function(key, index) {
	...
	StickyQuery.prototype.collectParameterValues = function(){
        ...
        this.allowedKeys.forEach(function(key){
	...
	StickyQuery.prototype.buildSelector = function(){
		...
		let excludedSelectors = Object.keys(this.exclusionRules).reduce(function(accumulator, key) {
	...
	StickyQuery.prototype.applyQueryParams = function(links){
        ...
        links.forEach(function(link){
			...
			if(plainLink.indexOf('#') !== -1){ 
				...
				queryLink = plainLink + this.persisted_string + fragment;
			}
	...
	StickyQuery.prototype.init = function(){
		...
		let selectedLinks = nodelistToArray(document.querySelectorAll(this.selector));
